...
uint32_t printsp(string str, uint32_t color, uint32_t px, uint32_t py, Framebuffer *fb);
void println(string str, Framebuffer *fb);
void printfs(const string str, const string istr, Framebuffer *fb);
void printfi(const string str, uint64_t value, Framebuffer *fb);
...
static const uint8_t ascii_font[95][13] = {
